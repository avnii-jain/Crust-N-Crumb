    ...
    <div className='flex items-center justify-between py-5 font-medium'>
      ...
      <div className='flex items-center gap-6'>
        ...
        <div className='group relative'>
            <Link to={'/login'}><img className='w-9 cursor-pointer' src={assets.profile_icon} alt="" /></Link>
        ...
        <img onClick={()=>setVisible(true)} src={assets.menu_icon} className='w-7 cursor-pointer sm:hidden' alt="" />
      ...
      {visible && (
        ...
        <div className='flex flex-col text-gray-600'>
            <div onClick={()=>setVisible(false)} className='flex items-center gap-4 p-3 cursor-pointer'>
                <img className='h-4 rotate-90 mt-5' src={assets.dropdown_icon} alt="" />
